...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_reviews_user_google
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_reviews_user_active_date
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_replies_review_user
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_replies_user_created
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_replies_review_status
    ON public.replies (review_id, status);

-- Index: users table — poller active user fetch
-- Used by run_poller.py: .eq("google_connected")
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_users_google_connected
